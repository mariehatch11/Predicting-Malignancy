...
# This shows how balanced the dataset is in terms of y values. This dataset is considered to be balanced. There are 212 malignant and 357 benign. 
y = data_mean.type
mal_freq = 0
ben_freq = 0
for w in y:
...
# This graphically represents the relative importance of the features. Some features 
x1=data_p.columns
